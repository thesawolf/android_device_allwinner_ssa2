...
$(call inherit-product-if-exists, vendor/allwinner/ssa2/ssa2-vendor.mk)
...
PRODUCT_COPY_FILES += \
	device/allwinner/ssa2/init.sun4i.modules.rc:root/init.sun4i.modules.rc \
	...
	device/allwinner/ssa2/config/Goodix-TS-board-3.idc:system/usr/idc/Goodix-TS-board-3.idc \
